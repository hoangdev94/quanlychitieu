...
class _StatisticsState extends State<Statistics>
  ...
  String formatDateTimeToVietnamese(DateTime dateTime) {
    // Tạo đối tượng DateFormat cho định dạng Việt Nam
    final dateFormat = DateFormat('dd/MM/yyyy HH:mm:ss');
    // Chuyển đổi đối tượng DateTime sang chuỗi có định dạng Việt Nam
            ...
            return ListTile(
              ...
              trailing: Text(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 17,
                  color: currListTransaction[index].type == 'Khoản chi'
                      ? Colors.red
                      : Colors.green,
                ),
              ),
